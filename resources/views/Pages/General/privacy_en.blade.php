...
@section('content')
    <section class="container" dir="ltr">
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to أمومة سعيدة, the software program provided by the Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to أمومة سعيدة.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Country</strong> refers to: Jordan</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to أمومة سعيدة, accessible from <a href="https://happymotherhood.blog/"
                        rel="external nofollow noopener" target="_blank">https://happymotherhood.blog/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: info@happymotherhood.blog</li>
        </ul>
    </section>
